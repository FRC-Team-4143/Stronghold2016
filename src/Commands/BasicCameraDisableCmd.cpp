...
BasicCameraDisableCmd::BasicCameraDisableCmd(std::shared_ptr<BasicCameraSub> camera)
...
void BasicCameraDisableCmd::Execute() {
	m_camera->Disable();
}
...
bool BasicCameraDisableCmd::IsFinished() {
	return true;
}
...
void BasicCameraDisableCmd::Interrupted() {
	End();
}
