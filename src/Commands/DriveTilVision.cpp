...
DriveTilVision::DriveTilVision(double y, double x, double twist, double timeout)
{
...
{
	return (Robot::visionBridge->GetDistance() != 0 && Robot::visionBridge->GetDistance() < 100) || IsTimedOut();
}
