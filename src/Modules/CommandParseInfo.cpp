...
CommandParseInfo::CommandParseInfo(std::string name, std::vector<std::string> aliases, std::function<void(std::vector<float>, std::function<void(Command*, float)>)> createCommand)
...
void CommandParseInfo::CreateCommand(std::vector<float> parameters, std::function<void(Command*, float)> addCommand) const {
